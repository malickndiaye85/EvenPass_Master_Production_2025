...
export default function EventDetailPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      // Format phone number with country code for PayDunya
      const phoneWithCountryCode = checkoutForm.customer_phone.startsWith('00221')
        ? checkoutForm.customer_phone
        : `00221${checkoutForm.customer_phone}`;
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 font-bold pointer-events-none" style={{ color: '#000000', zIndex: 10 }}>
                    +221
                  </div>
                  <input
                    type="tel"
