...
export default function AdminExportManager() {
  ...
  const exportToCSV = async () => {
    ...
    const headers = [
      ...
      'Organisateur',
      'Prix Billet (FCFA)',
      'Commission DemDem Transports & Events 5% (FCFA)',
  ...
  const exportToPDF = async () => {
    ...
    const htmlContent = `
      ...
      <body>
        <div class="header">
          <h1>🎫 DemDem Transports & Events - Rapport Financier</h1>
        ...
        <div class="summary">
          ...
          <div class="summary-grid">
            ...
            <div class="summary-item">
              <div class="summary-label">Commission DemDem Transports & Events (5%)</div>
        ...
        <div class="footer">
          <p>© ${new Date().getFullYear()} DemDem Transports & Events - Plateforme de gestion d'événements</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-white">
                    ...
                    <ul className="space-y-1 text-[#B5B5B5]">
                      ...
                      <li>• Commission DemDem Transports & Events (5%)</li>
                      <li>• Frais Mobile Money (1.5%)</li>
                      <li>• Net organisateurs (93.5%)</li>
                      <li>• Logo DemDem Transports & Events pour rendu officiel</li>
                    </ul>
                  </div>
                </div>
              </div>
