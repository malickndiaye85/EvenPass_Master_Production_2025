        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-zinc-400">Console de Supervision Technique EPscanV</p>
            </div>
      ...
      {view === 'grid' && (
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">Événements Actifs</h2>
              <p className="text-zinc-500">{events.length} événement(s) en supervision</p>
            </div>
            <div className="flex items-center gap-3 px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-lg">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
              <span className="text-zinc-400 text-sm">Synchronisé avec la plateforme</span>
            </div>
          </div>
